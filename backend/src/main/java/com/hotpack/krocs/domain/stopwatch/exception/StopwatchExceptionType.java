...
public enum StopwatchExceptionType implements BaseCode {
    STOPWATCH_CREATE_FAILED(HttpStatus.BAD_REQUEST, "STOPWATCH400", "스톱워치 생성이 실패했습니다."),
    STOPWATCH_FOUND_FAILED(HttpStatus.BAD_REQUEST, "STOPWATCH400", "스톱워치를 찾는 데 실패했습니다."),
    STOPWATCH_UPDATE_FAILED(HttpStatus.BAD_REQUEST, "STOPWATCH400", "스톱워치 수정이 실패했습니다."),
    ...
    STOPWATCH_ALREADY_PAUSED(HttpStatus.BAD_REQUEST, "STOPWATCH400", "이미 일시정지된 스톱워치입니다."),
    UNAUTHORIZED_STOPWATCH_ACCESS(HttpStatus.FORBIDDEN, "STOPWATCH403", "스톱워치 접근 권한이 없습니다.");
